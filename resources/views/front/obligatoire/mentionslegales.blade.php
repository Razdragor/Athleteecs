...
@section('content')
    <div class="pagesobligatory">
        ...
        <p>Le site <strong>ATHLETEEC</strong> est édité par :<strong>WHAT'S UP AGENCY</strong></p>
        <p>domicilié à l'adresse suivante : 90 AVENUE JEAN D ESTIENNE D ORVES JOINVILLE LE PONT.</p>
        ...
        <p><strong><br>ARTICLE 2 - ACCESSIBILITÉ</strong></p>
        ...
        <p><strong><br>ARTICLE 3 - COLLECTE DE DONNÉES ET LOI INFORMATIQUE ET LIBERTÉS</strong></p>
        ...
        <p>Pour faire usage de celui-ci, l'Utilisateur doit s'adresser à l'Éditeur en le contactant à l'adresse suivante : esgi.athleteec@gmail.com, ou par courrier adressé au domicile de l'Éditeur en précisant ses nom, prénom(s), adresse et adresse(s) e-mail.</p>
        <p>Pour tout signalement de contenus ou d'activités illicites, l'Utilisateur peut contacter l'Éditeur à l'adresse suivante : esgi.athleteec@gmail.com, ou par courrier recommandé avec accusé de réception adressé à l'Éditeur aux coordonnées précisées dans les présentes mentions légales.</p>
    </div>
@endsection