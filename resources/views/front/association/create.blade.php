...
@section('content')
    <div class="container">
        ...
        <div class="row" style="margin-top: 40px;">
            <form action="{{ route('association.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                {{ csrf_field() }}
                ...
                <input id="longitude" name="longitude" type="hidden" value="{{ old('lng') }}">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="autocomplete" placeholder="Indiquez une adresse" onFocus="geolocate()" type="text" class="form-control">
